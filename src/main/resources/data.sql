...
INSERT INTO `pet_health` (`pet_health_id`, `vaccinated`,`last_check_up`,`next_check_up`,`notes`) VALUES
(1,1,'1999-03-12','2023-04-01','n/a'),
(2,0,'1999-04-12','2023-03-24','Bites the vet'),
(3,1,'1999-05-12','2023-04-01','does not like jam'),
(4,0,'1999-06-12','2023-03-23','n/a');

INSERT INTO `pets` (`pet_id`, `name`,`pet_health_id`, `customer_id`) VALUES
(1, 'Francis',4,131),
(2, 'Martin',3,2),
(3, 'Bert',2,131),
(4, 'Zeke',1,131);

INSERT INTO `checkups` (`check_in_time`, `pet_id`) VALUES
('2002-03-23 12:03:45',4),
('2002-04-12 12:03:45',3),
('2002-05-01 12:03:45',2),
('2002-06-08 12:03:45',1);

INSERT INTO `events` (`event_id`, `title`,`date_of_event`,`description`,`customer_id`) VALUES
(1, 'March Pet Day', '2023-03-23', 'Come and celebrate your pets with us!', 131),
(2, 'April Pet Day', '2023-04-12', 'Come and celebrate your pets with us!', 2),
(3, 'May Pet Day', '2023-05-01', 'Come and celebrate your pets with us!', 131),
(4, 'June Pet Day', '2023-06-08', 'Come and celebrate your pets with us!', 131);